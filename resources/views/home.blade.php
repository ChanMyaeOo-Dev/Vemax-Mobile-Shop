        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            forms.forEach(function(form) {
                form.addEventListener('submit', function(event) {
                    ...
                    var submitBtn = document.getElementById('cart_submit_btn' + productId);
                    var loadingBtn = document.getElementById('loading_btn' + productId);
                    submitBtn.classList.add("d-none");
                    loadingBtn.classList.remove("d-none");
                    loadingBtn.classList.add("d-flex");
                    axios.post(this.action, formData) // Use axios to send a POST request
                        .then(function(response) {
                            ...
                            setTimeout(function() {
                                ...
                                cartCountSpan.innerText = response.data
                                    .count;
                            }, 1000);
                        })
